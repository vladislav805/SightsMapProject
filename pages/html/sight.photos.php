...
?>
<a href="<?=$photo->getUrlOriginal();?>" data-caption="<?=htmlSpecialChars(sprintf('Загружено %s пользователем <a href="/user/%s" target="_blank">@%s</a>', getRelativeDate($photo->getDate()), $author->getLogin(), $author->getLogin()));?>" data-noAjax>
